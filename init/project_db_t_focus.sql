...
CREATE TABLE `t_focus` (
  ...
  `user_id` int(11) NOT NULL COMMENT '粉丝id',
  `focus_to` int(11) NOT NULL COMMENT '关注人id',
  `focus_time` timestamp NULL DEFAULT NULL COMMENT '关注时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='关注-粉丝表';
